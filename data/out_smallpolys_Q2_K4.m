...
[* "supercuspidal ramified", 8, 5, 4,
    Fx!([[2, 1], [2],
    [2], [0], [2], [2], [0, 1], [0], [1]]),
    Fx!([(-266206626047928174314307673129*F.1 -
...
[* "supercuspidal ramified", 8, 5, 4,
    Fx!([[0, 1], [2],
    [2], [0], [0], [2], [0, 1], [2], [1]]),
    Fx!([-253530120045645880299340641075*F.1, 253530120045645880299340641075*F.1, 1])
*]
,
...
[* "supercuspidal ramified", 8, 11, 4,
    ...
    Fx!([(126765060022822940149670320538*F.1 - 
...
,
[* "supercuspidal ramified", 8, 12, 4,
    Fx!([[0, 1], [0, 4], [4], [4], [0, 5], [4, 4], [6, 6], [4, 4], [1]]),
    Fx!([-253530120045645880299340641075*F.1, 253530120045645880299340641075*F.1, 1])
*]
,
[* "supercuspidal ramified", 8, 14, 4,
    Fx!([[8, 5], [0], [4], [0, 4], [2, 4], [8], [0, 
    6], [0, 4], [1]]),
    Fx!([(126765060022822940149670320538*F.1 - 
        1)*F.1, 253530120045645880299340641075*F.1^2, 
    1])
...
,
[* "supercuspidal ramified", 8, 14, 4,
    Fx!([[0, 9], [0, 4], [0, 6], [0, 4], [12, 5], 
    [0, 8], [8, 4], [8], [1]]),
    Fx!([-253530120045645880299340641075*F.1, 253530120045645880299340641075*F.1, 1])
*]
,
[* "supercuspidal ramified", 8, 14, 4,
    Fx!([[8, 5], [0], [12], [0, 4], [10], [8], [0, 
    6], [0, 4], [1]]),
    Fx!([(126765060022822940149670320538*F.1 - 
        1)*F.1, 253530120045645880299340641075*F.1^2, 
    1])
...
,
[* "supercuspidal ramified", 8, 14, 4,
    Fx!([[8, 11], [0, 12], [8, 10], [0, 12], [4, 7],
    [0], [8], [8], [1]]),
    Fx!([-253530120045645880299340641075*F.1, 253530120045645880299340641075*F.1, 1])
*]
,
[* "supercuspidal ramified", 8, 14, 4,
    Fx!([[2, 9], [0], [8], [8, 4], [6, 10], [0, 12],
    [0, 2], [0, 12], [1]]),
    Fx!([(126765060022822940149670320538*F.1 - 
        3)*F.1, 253530120045645880299340641075*F.1^2, 
    1])
...
,
[* "supercuspidal ramified", 8, 14, 4,
    Fx!([[12, 15], [8, 4], [4, 14], [8, 4], [10, 5],
    [0], [0, 8], [8], [1]]),
    Fx!([-253530120045645880299340641075*F.1, 253530120045645880299340641075*F.1, 1])
*]
,
[* "supercuspidal ramified", 8, 14, 4,
    Fx!([[8, 7], [8, 4], [12, 6], [8, 4], [6, 5], 
    [0], [8, 4], [8], [1]]),
    Fx!([-253530120045645880299340641075*F.1, 253530120045645880299340641075*F.1, 1])
*]
,
...
,
[* "supercuspidal ramified", 8, 14, 4,
    Fx!([[4, 1], [8, 4], [12, 2], [8, 4], [2, 7], 
    [0], [8], [8], [1]]),
    Fx!([-253530120045645880299340641075*F.1, 253530120045645880299340641075*F.1, 1])
*]
,
[* "supercuspidal ramified", 8, 14, 4,
    Fx!([[8, 1], [8, 4], [4, 2], [8, 4], [14, 7], 
    [0], [8, 4], [8], [1]]),
    Fx!([-253530120045645880299340641075*F.1, 253530120045645880299340641075*F.1, 1])
*]
,
[* "exceptional SL(2,3)", 24, 13, 4,
    Fx!([[10, 14], [16, 16], [8, 4], [0, 16], [0, 8], 
    [0, 16], [0, 12], [8], [24, 30], [16], [16], [24, 24], 
    [28, 24], [0, 8], [0, 16], [24, 8], [0, 22], [0], [16, 16], [16, 
    24], [20, 12], [16, 8], [16], [0, 16], [10, 6], [0, 24], [20, 28], [24, 24], [16, 16], [0], [28, 12], [16, 28], [30, 
    26], [0], [16], [16, 20], [12,
    6], [8, 16], [24], [0, 12], [2, 24], [16, 16], [20], 
    [24, 16], [28, 18], [24, 8], [8, 8], [16], [1]]),
    Fx!([-2*F.1 - 9, -3*F.1 + 3, (126765060022822940149670320537*F.1 + 3)*F.1, 2*F.1
    ...
    , 100)|Polynomial([pAdicRing(2, 100) | 10, O(2^100), 1])>|2> | [[0, 1]], [0], [0], [[1]]])> | (3*$.1^2 + (-3*F.1 - 1)*$.1)*$.1, 
        253530120045645880299340641075*$.1^6, 1])*/
*]
,
[* "exceptional SL(2,3)", 24, 13, 4,
    Fx!([[2, 30], [0, 24], [8, 16], [0, 24], [12, 8], [8, 8], [16, 28], [24, 8], [6, 18], [24, 24], [8, 4], [0], [16], [24, 24], [24, 20], [8, 8], [26, 12], [8, 16], [16, 12], [16, 16], [12, 12], [0, 24], [8, 20], [16, 8], [22, 12], [0, 24], [4, 16], [16, 24], [12, 10], [16, 12], [28, 20], [0, 28], [28, 3], [24, 12], [24, 4], [0, 12], [20, 30], [24, 20], [24, 8], [24, 4], [24, 24], [16, 4], [24, 20], [24], [12, 6], 
    [16, 12], [24, 8], [16, 12], [1]]),
    Fx!([-2*F.1 - 9, -3*F.1 + 3, (126765060022822940149670320537*F.1 + 3)*F.1, 2*F.1
        + 7, 126765060022822940149670320537*F.1^2, 3, 1]),/*
    Polynomial([ext<ext<ext<pAdicField(2, 100)|Polynomial([pAdicRing(2, 100) | 
...
,
[* "exceptional SL(2,3)", 24, 13, 4,
    Fx!([[18, 26], [0, 16], [24, 20], [0, 8], [24, 20], [16], [8, 12], [24, 8], 
    [8, 30], [0, 8], [24], [24, 16], [28, 24], [24, 24], [0], [24, 
    24], [8, 8], [8, 24], [16, 8], [24, 8], [16, 12], [16, 8], [24], [0, 8], [2, 26], 
    [0], [28, 12], [16, 16], [12, 24], [16], [20], [24, 12], 
...
,
[* "exceptional SL(2,3)", 24, 13, 4,
    Fx!([[10, 6], [16, 8], [24, 8], [0, 16], [20, 16], [24, 24], [8, 28], [8], 
    [22, 18], [24], [0, 28], [0, 24], [0, 24], [24, 24], [0, 4], [24, 8], [18, 20], [0], [24, 
...
,
[* "exceptional SL(2,3)", 24, 13, 4,
    Fx!([[26, 6], [0, 16], [8, 20], [0, 16], [0], 
    [0], [0, 12], [8], [8, 22], 
    [0, 16], [16, 16], [24, 24], [12], [0, 8], [0], [24, 8], [0, 14], [16], [0, 16], [16, 8], 
    [4, 28], [0, 8], [0], [0, 16],
...
,
[* "exceptional SL(2,3)", 24, 13, 4,
    Fx!([[18, 6], [0, 24], [8], [0, 24], [28, 24], 
    [8, 24], [16, 28], [24, 8], [6, 18], [24, 24], [8, 4], [0], [16, 24]
...
,
[* "exceptional SL(2,3)", 24, 13, 4,
    Fx!([[26, 30], [16, 8], [24, 24], [0, 16], [4], 
    [24, 8], [8, 28], [8], [22, 2], [24, 16], [0, 28], [0, 24], [0], [24, 24], [0, 20], [24, 8]
...
, [16, 8], [0, 28], [12, 16], [0, 28], [4, 22], [20, 28], [24, 24], [10, 30], [20, 28], [4, 2], [20, 8], [24, 28], [0, 10], [30, 22], [0, 8], [2, 10], [22, 16], [2, 20], [24, 30], [4, 4], [18, 2], [28, 30], [28, 22], [30, 4], [26, 30], [30, 14], [30, 26], [8, 11], [0, 10], [26, 24], [20, 30], [16, 31], [20, 18], [26, 18], [8, 4], [2, 24], [24, 23], [18, 20], [18, 28], [1]]),
    ...
    Polynomial([ext<ext<ext<pAdicField(2, 100)|Polynomial([pAdicRing(2, 100) | 
    10, O(2^100), 1])>|2>|Polynomial([ext<ext<pAdicRing(2\
    , 100)|Polynomial([pAdicRing(2, 100) | 10, O(2^100), 1])>|2> | [[0, 1]], [0], [0], [[1]]])> | -63382530011411470074835160269*$.1, 
...
[* "exceptional SL(2,3)", 24, 8, 4,
    Fx!([[22, 30], [12, 12], [12, 10], [4, 28], [24, 16], [12, 24], [8, 22], [28, 24], [8, 16], [4, 24], [8, 26], [28, 24], [22, 14], [12, 12], [12], [28, 28], [20, 30],
...
,
[* "exceptional SL(2,3)", 24, 10, 4,
    Fx!([[26, 14], [8, 16], [24, 26], [24, 24], [0, 16], [8, 20], [28, 26], [0, 20], [28, 20], [28, 8], [20, 14], [0, 20], [30, 30], [12, 8], [4, 16], [16, 28], [12, 22], [20, 8], [26], [4, 20], 
...
[* "exceptional SL(2,3)", 24, 4, 4,
    Fx!([[14, 2], [0, 22], [28, 18], [20, 20], [12, 18], [12, 14], [20, 4], [28, 16], [24, 20], [16, 24], [20],
...
,
[* "exceptional SL(2,3)", 24, 10, 4,
    Fx!([[10, 6], [0, 16], [28, 14], [24, 16], [0, 16], [8, 12], [0, 10], [16, 20], [20, 12], [12], [8, 22], 
...
,
[* "exceptional SL(2,3)", 24, 8, 4,
    Fx!([[30, 2], [12, 20], [20, 6], [4, 12], [8, 16], [12], [24, 2], [28], [8, 
...
,
[* "exceptional SL(2,3)", 24, 10, 4,
    Fx!([[18, 14], [8], [16, 2], [24, 8], [0], [8, 20], [20, 10], [0, 20], [12, 20], [12, 8], [12, 14], [16, 20], [22, 22], [12, 24], [20, 16], [16, 12], [4, 14], [4, 24], [10, 16], [4, 20], [16, 18], [0, 16], [4, 16], [20, 4], [18, 22], [28, 4], [14, 8], [28, 16], [16, 18], [16, 8], [22, 14], [8, 28], [14, 14], [28, 10], [18, 6], [12, 8], [6], [0, 6], [24, 4], [4,
...
, [0, 24], [0, 12], [8], 
    ...
    Polynomial([ext<ext<ext<pAdicField(2, 100)|Polynomial([pAdicRing(2, 100) | 
    10, O(2^100), 1])>|2>|Polynomial([ext<ext<pAdicRing(2\
    , 100)|Polynomial([pAdicRing(2, 100) | 10, O(2^100), 1])>|2> | [[0, 1]], [0], [0], [[1]]])> | (253530120045645880299340641075*F.1*$.1^2 + (-3*F.1 - 1)*$.1
        + 3)*$.1, 253530120045645880299340641075*$.1^6, 1])*/
*]
,
[* "exceptional SL(2,3)", 24, 13, 4,
    Fx!([[10, 10], [16, 8], [24, 28], [0, 16], [8, 16], [16, 8], [8, 4], [24, 16], [12, 30], [8, 8], [0, 20], [16], [4, 24], [8, 24], 
    [0, 28], [0], [2, 26], [0, 8],
    [16, 8], [24, 24], [24, 24], [16], [0, 28], [16, 24], [30], 
    [16, 24], [28, 12], [16, 16], 
    [0], [24], [4, 4], [16, 28], 
    [0, 24], [0, 28], [24, 8], 
    [0], [12, 6], [8, 20], [8, 16], [0, 12], [22, 2], [16, 12], [20, 16], [0, 4], [28, 30], [8, 28], [4, 16], [24, 12], [1]]),
    Fx!([-2*F.1 - 9, -3*F.1 + 3, (126765060022822940149670320537*F.1 + 3)*F.1, 2*F.1
        + 7, 126765060022822940149670320537*F.1^2, 3, 1]),/*
    Polynomial([ext<ext<ext<pAdicField(2, 100)|Polynomial([pAdicRing(2, 100) | 
    10, O(2^100), 1])>|2>|Polynomial([ext<ext<pAdicRing(2\
...
,
[* "exceptional SL(2,3)", 24, 13, 4,
    Fx!([[18, 2], [16, 8], [8, 28], [0, 8], [8], 
    [16, 8], [16, 28], [8], [8, 26], [16, 16], [0, 12], [0], [4, 8], [8, 24], [8, 4], [8, 16], [28, 12], [24], [8, 8], 
    [8], [16, 20], [16, 16], [8], [8, 24], [2, 14], [8, 24], [12, 12], [0, 8], [0, 12], [8, 8], [4, 24], [0, 4], 
    [30, 30], [16, 24], [4, 28], [16], [8, 18], [24, 28], [28, 4], [24, 12], [0, 2], [8, 12], [20, 24], [24, 20], [4, 20], [0], [24, 20], [8, 4], [1]]),
    Fx!([-2*F.1 - 9, -3*F.1 + 3, (126765060022822940149670320537*F.1 + 3)*F.1, 2*F.1
        + 7, 126765060022822940149670320537*F.1^2, 3, 1]),/*
    Polynomial([ext<ext<ext<pAdicField(2, 100)|Polynomial([pAdicRing(2, 100) | 
    10, O(2^100), 1])>|2>|Polynomial([ext<ext<pAdicRing(2\
...
,
[* "exceptional SL(2,3)", 24, 13, 4,
    Fx!([[2, 26], [16, 24], [16, 4], [16, 24], [0], [0, 16]
, [16, 28], [8, 16], [12, 14], [24], [8, 20], [0], [12], [24, 8], [8, 20], [16, 8], [18, 26], [0, 24], [0, 16], [0], [16, 28], [24, 8], [8, 12]
, [24], [6, 20], [0, 16],
    [20, 16], [0], [24, 24], [8, 24], [12, 8], [8, 28], [16, 20], [24, 12], [24, 16], [24],
...
,
[* "exceptional SL(2,3)", 24, 13, 4,
    Fx!([[10, 2], [0, 8], [24, 12], [0, 16], [8, 8], [16, 24], [8, 20], [24, 16], [12, 14], [8, 8], [0, 4],
    [16], [20, 16], [24, 8], [0, 12], [0], [18, 2], [16, 24], [0, 24]
...
,
[* "exceptional SL(2,3)", 24, 13, 4,
    Fx!([[18, 26], [0, 8], [8, 28], [0, 8], [24, 8],
    [0, 24], [16, 28], [8], [24, 26], [0, 16], [0, 12], [0], [4], [24, 8], [8, 20], [8, 16], [28, 4], [24, 16], [24, 24], [8, 16], [0, 28], [16], 
...
,
[* "exceptional SL(2,3)", 24, 13, 4,
    Fx!([[2, 2], [0, 24], [16, 20], [16, 24], [0, 8], [0, 16], [16, 12], [8, 16], [12, 14], [24, 16], [8, 4], [0], [28, 8], [24, 24], [8, 4], [16, 8], [18, 2], [0, 24], [16, 16], [0, 16], [16, 12], [8, 8], [24, 12], [24], 
    [14, 28], [16, 8], [20], [0, 16], [16, 24], [8, 8], [12, 24], [8, 28], [24, 12], [24, 20], [24, 16], [24], [4, 14], 
    [0, 28], [0, 8], [0, 20], [14, 14], [0, 4], [4, 28], [0], [8, 14], [16], [12, 4], [24, 8], 
    [1]]),
    Fx!([-2*F.1 - 9, -3*F.1 + 3, (126765060022822940149670320537*F.1 + 3)*F.1, 2*F.1
        + 7, 126765060022822940149670320537*F.1^2, 3, 1]),/*
    Polynomial([ext<ext<ext<pAdicField(2, 100)|Polynomial([pAdicRing(2, 100) | 
...
[* "exceptional SL(2,3)", 24, 9, 4,
    ...
    [8, 24], [0, 14], [16, 16], [8, 28], [0, 8], [8], [0], [16, 16], [0, 20], [4, 12], [0, 8],
    ...
    Polynomial([ext<ext<ext<pAdicField(2, 100)|Polynomial([pAdicRing(2, 100) | 
    10, O(2^100), 1])>|2>|Polynomial([ext<ext<pAdicRing(2\
    , 100)|Polynomial([pAdicRing(2, 100) | 10, O(2^100), 1])>|2> | [[0, 1]], [0], [0], [[1]]])> | $.1, 253530120045645880299340641075*$.1^4, 1])*/
*]
,
[* "exceptional SL(2,3)", 24, 10, 4,
    Fx!([[-112837116202762734339502202466, 
...
,
[* "exceptional SL(2,3)", 24, 9, 4,
    Fx!([[2, 28], [16], [16, 24], [0], [8, 24], 
    [0], [8, 8], [24, 24], [16, 4], [16], [8, 28], [16, 20], 
...
,
[* "exceptional SL(2,3)", 24, 10, 4,
    Fx!([[474690320908092794062973539310, 
...
, [0, 24], [16, 8], [0, 28], [16, 16], [0, 4], [12, 28], [0, 24], [28, 8], [20, 16], [16, 8], [0], [4, 20], [0, 24], [4, 4], [16], [24, 8], 
...
,
[* "exceptional SL(2,3)", 24, 10, 4,
    Fx!([[-624722455376975081451093794466, 
...
,
[* "exceptional SL(2,3)", 24, 9, 4,
    Fx!([[18, 4], [16], [0], [0], [24, 16], [24, 16], [24, 8], [24, 8], [16, 28], [0], [8, 20], [0, 12], [8, 20], [8], [24, 20], [16, 16], [0, 24], [24, 20], [24, 24], [24], [20, 16], [24, 24],
...
,
[* "exceptional SL(2,3)", 24, 10, 4,
    Fx!([[-385296978002671271676701293602, 
...
[* "exceptional SL(2,3)", 24, 9, 4,
    ...
    [8, 8], [0, 26], [16, 16], [8, 20], [0, 24], [24], [0], [16, 16], [0, 28], [4, 4], [0, 24],
    [28, 8], [20, 16], [8, 8], [16, 24], [12, 12], [0, 8], [12, 20], [16, 24], [8, 16], [24, 16], [8, 30], [16, 8], [24, 12], [0, 28], [1]]),
    Fx!([-2*F.1 - 9, -3*F.1 + 3, (126765060022822940149670320537*F.1 + 3)*F.1, 2*F.1
        + 7, 126765060022822940149670320537*F.1^2, 3, 1]),/*
    Polynomial([ext<ext<ext<pAdicField(2, 100)|Polynomial([pAdicRing(2, 100) | 
    10, O(2^100), 1])>|2>|Polynomial([ext<ext<pAdicRing(2\
    , 100)|Polynomial([pAdicRing(2, 100) | 10, O(2^100), 1])>|2> | [[0, 1]], [0], [0], [[1]]])> | 3*$.1, 253530120045645880299340641075*$.1^4, 1])*/
*]
,
[* "exceptional SL(2,3)", 24, 10, 4,
    Fx!([[267479756225391279393339479090, 
...
,
[* "exceptional SL(2,3)", 24, 9, 4,
    Fx!([[18, 12], [16, 16], [0], [0], [8], [8, 8], 
    [24, 8], [24, 24], [16, 12], 
    [0], [8, 28], [0, 20], [8, 12], [24, 16], [8, 12], [16, 16], [16, 24], [8, 28], [24, 8], [24], [4, 24], [24, 24], 
    [0, 4], [16, 20], [20, 18], [0, 24], [16, 16], [16, 24], [0, 4], [24, 4], [0, 28], [16, 12], [12, 28], [0], [4, 24], [4, 12]
...
,
[* "exceptional SL(2,3)", 24, 10, 4,
    Fx!([[131269007859283642190007809842, 
...
,
[* "exceptional SL(2,3)", 24, 10, 4,
    Fx!([[-239447910363676741156423256382, 
...
,
[* "exceptional SL(2,3)", 24, 9, 4,
    Fx!([[2, 20], [16, 16], [16, 8], [0], [24, 24], [16, 8]
...
,
[* "exceptional SL(2,3)", 24, 10, 4,
    Fx!([[305841607054889449095694345554, 
...
[* "exceptional SL(2,3)", 24, 7, 4,
    Fx!([[26, 12], [16, 28], [16, 4], [16, 24], [20, 4], [0, 24], [16, 20], [0], [16, 
    16], [8], [28, 4], [0, 24], [20], [8, 28], [0], [0, 16], [12, 8], [16, 12], [0, 4], [16, 16], [0, 4], [16, 4], [20, 20], [16, 16], [20, 18], [20, 16], [28, 28], [0, 16], [16, 10], [24, 16], [28, 28], [16, 24], [8, 24], [0, 4], [28, 6], [24], [0, 8], 
    ...
    Polynomial([ext<ext<ext<pAdicField(2, 100)|Polynomial([pAdicRing(2, 100) | 
    10, O(2^100), 1])>|2>|Polynomial([ext<ext<pAdicRing(2\
    , 100)|Polynomial([pAdicRing(2, 100) | 10, O(2^100), 1])>|2> | [[0, 1]], [0], [0], [[1]]])> | (63382530011411470074835160269*F.1*$.1 + 
        253530120045645880299340641075)*$.1, 
        253530120045645880299340641075*$.1^3, 1])*/
*]
,
[* "exceptional SL(2,3)", 24, 10, 4,
    Fx!([[482026081047950980418234767050, 
...
,
[* "exceptional SL(2,3)", 24, 8, 4,
    Fx!([[30, 16], [16, 28], [8, 4], [16, 16], [24, 28], [16, 8], [24, 28], [16, 28], [8, 20], [0, 24], [24], 
...
,
[* "exceptional SL(2,3)", 24, 10, 4,
    Fx!([[375467256979033465233630315338, 
...
,
[* "exceptional SL(2,3)", 24, 7, 4,
    Fx!([[14, 16], [16, 4], [8, 20], [0, 24], [20, 4], [0, 8], [24, 28], [0], [16, 20]
, [0], [20, 24], [16, 8], [4, 
...
,
[* "exceptional SL(2,3)", 24, 10, 4,
    Fx!([[332417422351080243422379611690, 
...
,
[* "exceptional SL(2,3)", 24, 8, 4,
    Fx!([[30], [8, 12], [8, 12], [0, 16], [16, 4], [0, 8], [24, 4], [0, 28],
    [24, 28], [16, 8], [16, 24], [0, 16], [12, 12], [0, 8], [0, 16], [24], [4, 24], [0], [24, 16], [8], [24, 16], [24, 12], 
...
,
[* "exceptional SL(2,3)", 24, 10, 4,
    Fx!([[83476010314576974224171488090, 
...
,
[* "exceptional SL(2,3)", 24, 13, 4,
    Fx!([[26, 18], [0, 16], [16, 12], [16, 24], [24, 12], [0, 16], [24, 20], [8, 24], [4, 18], [0, 16], [16, 16], [24, 8], [20, 8], [16, 24], [24, 4], [8, 8], [28, 6],
    [16, 16], [8, 8], [24, 8], [12, 4], [16, 24], [8, 12], [16, 16], [10, 10], [0], [20, 28], [16, 
...
, [8], [28, 16], [16, 8],
    ...
    Polynomial([ext<ext<ext<pAdicField(2, 100)|Polynomial([pAdicRing(2, 100) | 
    10, O(2^100), 1])>|2>|Polynomial([ext<ext<pAdicRing(2\
    , 100)|Polynomial([pAdicRing(2, 100) | 10, O(2^100), 1])>|2> | [[0, 1]], [0], [0], [[1]]])> | ((-126765060022822940149670320538*F.1 + 3)*$.1^2 + (2*$.1 + 
        2)*$.1 + (-F.1 - 3)*$.1)*$.1, 
        253530120045645880299340641075*$.1^6, 1])*/
*]
,
[* "exceptional SL(2,3)", 24, 13, 4,
    Fx!([[2, 2], [16], [16], [16], [20, 16], [8,
    ...
    [0, 20], [0, 10], [0], [12, 16], [0, 12], [0, 22], [0, 28], [16, 16], [16, 20], [1]]),
    Fx!([-2*F.1 - 9, -3*F.1 + 3, (126765060022822940149670320537*F.1 + 3)*F.1, 2*F.1
        + 7, 126765060022822940149670320537*F.1^2, 3, 1]),/*
    Polynomial([ext<ext<ext<pAdicField(2, 100)|Polynomial([pAdicRing(2, 100) | 
    10, O(2^100), 1])>|2>|Polynomial([ext<ext<pAdicRing(2\
...
,
[* "exceptional SL(2,3)", 24, 13, 4,
    Fx!([[2, 22], [16, 24], [24, 4], [0], [16, 8], [16, 24]
, [16, 28], [8, 8], [12, 6], [0], [16, 24], [24], [20, 8], [24, 24], [0, 20], [24, 16], [8, 4], [8, 8], [0, 8], 
...
,
[* "exceptional SL(2,3)", 24, 13, 4,
    Fx!([[10, 10], [16], [16, 12], [16, 24], [24, 20], [0], [24, 20], [8, 24], [4, 26]
, [16], [16], [24, 8], 
    [4, 16], [0, 8], [24, 4], [8, 8], [12, 14], [0], [24, 24], [24, 
...
,
[* "exceptional SL(2,3)", 24, 13, 4,
    Fx!([[2, 30], [0, 24], [24, 4], [0], [0], [16, 8], [16, 28], [8, 8], [28, 22], [16, 16], [16, 24], [24],
    [4], [24, 24], [0, 20], [24, 16], [24, 28], [24, 8], [16, 24], [0], [0, 28], [16, 16], [24, 4]
...
[* "exceptional SL(2,3)", 24, 13, 4,
    Fx!([[10, 10], [0], 
    [24, 12], [0, 8], [24, 16], [0, 16], [16, 12], [24, 16], [20, 18], [0], [24, 12], [16, 24], [28, 
    16], [16, 8], [0, 16], [24], [16, 14], [16, 8], [0, 8], [8, 16], [28, 4], [16, 24], [24, 8], [16], [26, 10], 
    [16], [28, 8], [0, 24], [0, 8], [0], [12, 16], [24, 28], [22, 
    ...
    Polynomial([ext<ext<ext<pAdicField(2, 100)|Polynomial([pAdicRing(2, 100) | 
    10, O(2^100), 1])>|2>|Polynomial([ext<ext<pAdicRing(2\
    , 100)|Polynomial([pAdicRing(2, 100) | 10, O(2^100), 1])>|2> | [[0, 1]], [0], [0], [[1]]])> | ((126765060022822940149670320537*F.1 + 2)*$.1^2 + (-3*F.1 - 
...
,
[* "exceptional SL(2,3)", 24, 13, 4,
    Fx!([[18, 30], [16], [8, 20], [0], [8, 4], [0, 24], [8, 4], [8, 16], [28, 2],
...
,
[* "exceptional SL(2,3)", 24, 13, 4,
    Fx!([[18, 22], [0, 16], [0, 20], [16, 16], [0, 28], [0, 8], [8, 4], [8, 8], 
    [8, 22], [24, 16], [8, 4], 
    [0], [4, 16], [8, 24], [16, 8], [16, 8], [2, 26], [0, 16], [24, 12], [0, 8], [8, 20], [8, 16], [16, 28], [0], [18, 
    24], [8, 16], [28], [8, 8], [12, 16], [0, 24], [4], 
    [0, 20], [8, 20], [24, 20], [0, 4], [0], [0, 10], [16, 12], [28, 
...
,
[* "exceptional SL(2,3)", 24, 13, 4,
    Fx!([[26, 2], [16], [24, 28], [0, 8], [24, 24], [16], [16, 12], [24, 16],
    [4, 26], [16, 16], [24, 12], [16, 24]
, [28, 24], [0, 8], [0], [24], [16, 22], [0, 8], [16, 24], [8], [12, 28], [16, 24], 
...
,
[* "exceptional SL(2,3)", 24, 13, 4,
    Fx!([[26, 14], [16], [24, 28], [16, 24], [8, 20], [0, 16], [0, 4], [8], 
    [16, 22], [24], [16, 12], [0, 24], [12, 8], [8, 24], [0, 8],
    [0, 24], [10, 10], [16, 16], [16, 4], [8], [8, 24], [0], [24, 20], [24, 16], [26, 20], [8, 8], [4, 4], [8], [28, 24], 
...
[* "exceptional SL(2,3)", 24, 13, 4,
    ...
    [24], [0, 8], [8, 8], [4, 8], [8, 8], [24, 16], [0], [8, 24], [16, 16], [0, 8], [24],
    [18, 2], [16], [28, 24], [24, 24], [12, 24], [8], [4, 12], 
    [24, 4], [30, 22], [8, 16], [12, 4], [24, 24], [8, 26], [8, 12], [0], [8, 28], [24, 30], [8, 4], [20, 12], [8, 24], [12, 8], [8, 16], [8, 20], [8, 4],
    [1]]),
    Fx!([-2*F.1 - 9, -3*F.1 + 3, (126765060022822940149670320537*F.1 + 3)*F.1, 2*F.1
        + 7, 126765060022822940149670320537*F.1^2, 3, 1]),/*
    Polynomial([ext<ext<ext<pAdicField(2, 100)|Polynomial([pAdicRing(2, 100) | 
...
,
[* "exceptional SL(2,3)", 24, 13, 4,
    Fx!([[18, 14], [16], [0, 20], [16, 16], [0, 20], [0, 24], [8, 20], [8, 8],
    [24, 6], [24], [8, 20], [0], 
    [20, 24], [8, 24], [16, 24], [16, 8], [18, 18], [0, 16], [8, 12], [0, 24], [8, 4], [24, 16], [0, 12], [0], [10], [24, 24], [12], [8, 24], [20, 24], 
...
,
[* "exceptional SL(2,3)", 24, 7, 4,
    Fx!([[22], [16, 8], [16, 16], [0, 16], [24, 28], [16], [16, 16], [0], [8, 16], [0], [24, 8], [0, 24], [12], [0], [16], [16], [8, 24], [8], [0, 24], [16, 24], 
    [12, 8], [0, 24], [16, 24], 
    [0], [0, 22], [0, 16], [0, 20], [8], [20, 4], [16, 16], 
    [16, 16], [0, 16], [0, 12], [0, 16], [16, 8], [8, 16], [0, 24], [0, 24], [24], [0, 24], 
    [0, 20], [0, 16], [12], [8, 24], [16, 22], [8, 16], [16, 8], [0], [1]]),
    Fx!([-2*F.1 - 9, -3*F.1 + 3, (126765060022822940149670320537*F.1 + 3)*F.1, 2*F.1
        + 7, 126765060022822940149670320537*F.1^2, 3, 1]),/*
    Polynomial([ext<ext<ext<pAdicField(2, 100)|Polynomial([pAdicRing(2, 100) | 
    10, O(2^100), 1])>|2>|Polynomial([ext<ext<pAdicRing(2\
    , 100)|Polynomial([pAdicRing(2, 100) | 10, O(2^100), 1])>|2> | [[0, 1]], [0], [0], [[1]]])> | (253530120045645880299340641075*$.1 + 
        253530120045645880299340641075)*$.1, 
        253530120045645880299340641075*$.1^3, 1])*/
*]
,
[* "exceptional SL(2,3)", 24, 10, 4,
    Fx!([[433869224616606860673305485814, 
...
,
[* "exceptional SL(2,3)", 24, 8, 4,
    Fx!([[18, 4], [24, 24], [0, 24], [16], [24, 16], 
    [8, 8], [0, 20], [8, 28], [16, 4], [16, 16], [0], [0, 8], [12, 4], [24, 20], [16, 12], [16], [0, 20], [24, 20], [8, 28], [24, 24], [8, 24], [24, 24], [8, 16], [16, 8], [0, 10], [24, 20], [0, 8], [16, 16], [0, 20], [24, 4], [20, 8], [28, 24], [20, 28], [0, 16], [16, 16], [24], [4, 8], 
...
,
[* "exceptional SL(2,3)", 24, 10, 4,
    Fx!([[-95749409060795956625541069354, 
...
,
[* "exceptional SL(2,3)", 24, 7, 4,
    Fx!([[2, 12], [0, 24], [16, 16], [16], [16, 4], 
    [16], [16], [0], [24, 20], 
    [16, 24], [8, 16], [0, 24], [4], [0], [16], [16], [0, 20], [24, 24], [24], [0, 24], 
    [4, 12], [0, 24], [0, 24], [0, 16], [16, 26], [16, 8], [8, 28], [8], [28, 28], [16, 16], 
    [0, 8], [0, 16], [12, 28], [16], [16, 8], [8, 24], [28, 28], [0, 8], [8, 24], [0, 8], 
    [12, 8], [8], [12, 4], [8, 24], [16, 6], [8, 24], [16, 8], [0], [1]]),
    Fx!([-2*F.1 - 9, -3*F.1 + 3, (126765060022822940149670320537*F.1 + 3)*F.1, 2*F.1
        + 7, 126765060022822940149670320537*F.1^2, 3, 1]),/*
    Polynomial([ext<ext<ext<pAdicField(2, 100)|Polynomial([pAdicRing(2, 100) | 
    10, O(2^100), 1])>|2>|Polynomial([ext<ext<pAdicRing(2\
...
,
[* "exceptional SL(2,3)", 24, 10, 4,
    Fx!([[370952558793176782351764354374, 
...
,
[* "exceptional SL(2,3)", 24, 8, 4,
    Fx!([[2, 28], [16], [0], [16], [8], [8], [0, 28], [24, 12], [16, 12], [0, 16], [16, 16], [16, 8], [12, 20], [16, 28], [16, 12], [16, 16], [0, 20], [24, 4], [16, 20], [16, 8], [24, 24], [8, 8], [24, 24], [16, 24], [8, 14], [8, 16], [24], 
    [16, 16], [0, 12], [16, 4], [4, 24], [28, 24], [20, 28], [0, 24], [0], [24], [4], [28], [4, 16], [0, 24], [4, 20], [12], [12, 4], [8], [0, 
    4], [24, 4], [8, 8], [0, 4], [1]]),
    Fx!([-2*F.1 - 9, -3*F.1 + 3, (126765060022822940149670320537*F.1 + 3)*F.1, 2*F.1
        + 7, 126765060022822940149670320537*F.1^2, 3, 1]),/*
    Polynomial([ext<ext<ext<pAdicField(2, 100)|Polynomial([pAdicRing(2, 100) | 
...
,
[* "exceptional SL(2,3)", 24, 10, 4,
    Fx!([[90747751837498917886791312342, 
